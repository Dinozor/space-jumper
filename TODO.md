...
- [ ] Level select only shows one level even though multiple `.tres` files exist in `resources/levels/` — investigate LevelLoader or level_select.gd to find why only one entry appears
